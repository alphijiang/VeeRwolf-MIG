...
# Create the two board-specific AMD IP blocks used by the Nexys4 DDR target.
# Each IP has its own output root so Vivado never sees shared XCI output paths.

if {[info exists ::veerwolf_nexys4_mig_loaded]} { return }
set ::veerwolf_nexys4_mig_loaded 1

set here [file dirname [file normalize [info script]]]
set mig_prj [file join $here mig.prj]
if {![file isfile $mig_prj]} {
    error "Digilent Nexys4 DDR C.1 MIG project is missing: $mig_prj"
}

set mig_name design_1_mig_7series_0_2
set cdc_name nexys4_axi_clock_converter
...
# Do not retain stale MIG project-file references in the generated XPR. The
# valid C.1 project above is preserved and remains the MIG configuration input.
